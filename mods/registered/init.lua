...
-- ── Bouwers Hamer (breekt alles in 1 klap, voor het bouwen van de arena) ────
...
-- ── Fietsenrek (decoratief) ────────────────────────────────────────────────
-- Decoratieve fietsenrekken met geparkeerde fietsen, voor de fietsenstalling
