...
local function build_shop_formspec(npc_name, coins)
	return
		...
		"image_button[3.5,1.8;2,2;registered_sword_steel.png;buy_sword_steel;]" ..
		"label[3.5,4.0;Stalen Zwaard]" ..
		"label[3.5,4.5;15 munten]" ..

		-- Bronzen Zwaard (25 coins)
		"image_button[6.5,1.8;2,2;registered_sword_bronze.png;buy_sword_bronze;]" ..
		"label[6.5,4.0;Bronzen Zwaard]" ..
		"label[6.5,4.5;25 munten]" ..

		"button_exit[3.5,6.5;3,0.8;close;Sluiten]"
end
